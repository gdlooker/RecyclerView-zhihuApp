package com.example.com.zhuangbi.customview;
...
public class Kanner extends FrameLayout implements OnClickListener {
    private List<Latest.TopStoriesEntity> topStoriesEntities;//集合
    ...
    private void initUI() {
        ...
        //这个是将imageView添加到水平的线性布局中
        for (int i = 0; i < len; i++) {
            ImageView iv_dot = new ImageView(context);//实例
            ...
            //
            ll_dot.addView(iv_dot, params);//这个是图片线性布局
            iv_dots.add(iv_dot);//图片集合
        }
...
//            iv.setBackgroundResource(R.drawable.loading1);
        ...
        vp.setCurrentItem(1);//其实是在长度中的第二张图片
        currentItem = 1;
